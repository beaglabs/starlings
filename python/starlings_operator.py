...
def decode_request(text: str) -> Dict[str, Any]:
    ...
    for line in lines[1:]:
        ...
        if line.startswith("operator="):
            ...
            ctx["provides"]["variables"].append(int(line.split("=", 1)[1]))
        elif line.startswith("provide_inv="):
            ctx["provides"]["invariants"].append(int(line.split("=", 1)[1]))
        else:
